...
{
    private:
        std::atomic<DATATYPE*>* arr; // a pointer to another pointer to the array; 
                        // (there are two copies of the array and the pointer to the two copies needs to be able to be safely changed across threads)
